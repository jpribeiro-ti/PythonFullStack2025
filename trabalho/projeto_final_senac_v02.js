...
class Aluno {
    constructor(){
        ...
        this.matriculaAluno = entradaDados.question("Digite a matricula do(a) Aluno(a): ");
...
let aluno1 = new Aluno(); // Criando uma instância de Aluno com entrada de dados do usuário

// Adicionando notas ao aluno com entrada de dados do usuário
for (let contador = 1; contador <= 4; contador++) {
    let nota = Number(entradaDados.question(`Digite a nota do ${contador} bimestre: `));
    aluno1.adicionarNota(nota);
}

// Exibindo a média do aluno
console.log(`Media do(a) Aluno(a) ${aluno1.nomeAluno}, matricula ${aluno1.matriculaAluno}, na materia ${aluno1.cursoMatriculado}: ${aluno1.calcularMedia().toFixed(2)}`);
